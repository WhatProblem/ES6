...
module.exports = {
    ...
    resolve: { // 解析第三方包 commonjs规则
        modules: [path.resolve('node_modules')],
        // alias: { // 使用别名 import'bootstrap/dist/css/bootstrap.css' => import'bootstrap'
        //     bootstrap: 'bootstrap/dist/css/bootstrap.css'
        // }
        // mainFields: ['style', 'main'], // 引入文件时查找的区域，从左往右查找style不存在就找main（对应的从依赖包的package.jon配置里查找）
        // mainFiles: ['index.js'], // 入口文件名字 index.js
        extensions: ['.js', '.css', '.json', '.vue'], // 文件扩展名，可直接import './index'
    },
}
